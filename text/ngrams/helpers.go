...
// FrequencyTableByParsingWords creates a new frequency table by parsing word ngrams from the given input paths.
func FrequencyTableByParsingWords(ctx context.Context, paths []string,
	language alphabet.Language, tokenSize int) (*FrequencyTable, error) {
