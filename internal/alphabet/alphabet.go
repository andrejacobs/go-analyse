...
type Language struct {
	...
	Code LanguageCode
	// Letters (in UTF-8 and lowercase) found in the language.
	Letters string
}

// LanguageMap is used to map from an language code to info about the language.
...
// that make up the alphabet and thus the specified rune is assumed to be a lowercase rune.
